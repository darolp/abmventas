...
$aProductos = $tipoProducto->obtenerTodos();

include_once('header.php'); //Como contiene codigo de maquetacion HTML se incluye al final
?>
<!-- Begin Page Content -->
<div class="container-fluid">
    ...
    <table class="table table-hover border">
        ...
        <?php foreach($aProductos as $tipo): ?>
            <tr>
